           ...
           withSegmentResolver:(id<IJKMediaSegmentResolver>)segmentResolver
{
    ...
    if (self) {
        ...
        //colin added for 实时流
        ijkmp_set_option(_mediaPlayer, IJKMP_OPT_CATEGORY_FORMAT, "analyzeduration", "2000000");
        ijkmp_set_option(_mediaPlayer, IJKMP_OPT_CATEGORY_FORMAT, "probesize", "4096");
        ijkmp_set_option(_mediaPlayer, IJKMP_OPT_CATEGORY_FORMAT, "probesize2","4096");
