...
//        })
    ...
    override func layoutSubviews () {
        ...
        self.width = Float(indicatorFrame!.size.width) + (10.0 * margin)
        self.height = Float(indicatorFrame!.size.height) + (5.0 * margin)
...
//        if countElements(labelText) != 0 {
    ...
    func hideAndRemove (animation:Bool, completion: () -> Void) {
        if animation == true {
