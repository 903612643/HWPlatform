...
//    }
    ...
    public func addLable(title:String?=nil)->UILabel {
        // Update view height
        kWindowHeight += kLabelHeight
        // Add Lable
        let Label = UILabel()
//        txt.borderStyle = UITextBorderStyle.RoundedRect
//        txt.font = UIFont(name:kDefaultFont, size: 14)
...
//        inputs.append(txt)
    ...
    // showCustom
    public func showCustom(title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0, colorStyle: UInt=0xA429FF, colorTextButton: UInt=0xFFFFFF) -> SCLAlertViewResponder  {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .Edit, colorStyle: colorStyle, colorTextButton: colorTextButton)
    }
