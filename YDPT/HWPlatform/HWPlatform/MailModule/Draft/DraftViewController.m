...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"ShowDraftView"]) {
        ...
        controller.navigationItem.title = @"草稿";
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Draft" inManagedObjectContext:self.managedObjectContext];
